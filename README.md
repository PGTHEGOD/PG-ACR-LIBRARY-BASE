...
- เปิด `http://localhost:3000/print` บนเครื่องพิมพ์ (ใช้รหัส `LIBRARY_ACCESS_CODE` เดียวกับหน้า Admin)
- กด **สร้าง QR ใหม่** (อายุ 10 นาที) ระบบจะแสดง QR + ลิงก์ `/print/join/[sessionId]` เฉพาะเครื่องที่เปิดหน้านี้เท่านั้น
- นักเรียนสแกน QR แล้วอัปโหลดไฟล์ได้หลายไฟล์ต่อเซสชัน (PDF / DOCX / รูปภาพ ฯลฯ) ไฟล์จะถูกส่งขึ้นเซิร์ฟเวอร์และเก็บไว้ชั่วคราวในฐานข้อมูล MySQL
- หน้าครูจะแสดงรายการไฟล์ทั้งหมด สามารถเปิด **Print Preview** หรือดาวน์โหลดเป็นไฟล์ปกติเพื่อสั่งพิมพ์เองได้
- เมื่อปิดหน้าจอหรือกด “ปิดการเชื่อมต่อ” ระบบจะลบไฟล์ทั้งหมดและถือว่า QR หมดอายุทันที (หรือหมดอายุอัตโนมัติเมื่อครบเวลา)
